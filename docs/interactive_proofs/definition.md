...
>
> **対話チューリング機械**とは、以下の六つのテープからなる決定的チューリング機械である：
> 1. 入力テープ (read-only)
...
> 6. 出力テープ (write-only)
>
> 送信テープと受信テープをまとめて通信テープと呼ぶこともある。
>
> **対話するチューリング機械の組**とは、通信テープを共有している二つの対話チューリング機械$M_1,M_2$からなる組$\langle M_1,M_2 \rangle$であり、次の性質を満たす：
...
> **定義（対話証明系）**
>
> 言語$L$に対する**対話証明系**とは、対話するチューリング機械の組$\langle P,V \rangle$であって、以下の性質を満たすものである：
> - $V$は乱択多項式時間アルゴリズムです
