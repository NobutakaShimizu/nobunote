...
<summary style="display: list-item">全体の要約</summary>
  ゼロ知識証明系とは, ある命題が真であることを証明する際に, その証明それ自体以外の情報を一切漏らさない証明方法です. 論文では, NP（非決定性多項式時間）問題全てに対し, 安全な暗号化関数の存在を仮定すればゼロ知識証明系が存在することを示しています. さらに, グラフ同型性問題とグラフ非同型性問題について, 暗号化関数を用いないゼロ知識証明系を提示しています.
</details>
